...
* Сказать по правде, это задание с одного из моих собеседований. Когда я его писал, мой интервьюер постоянно напоминал мне про тесты фразами: "Может быть к этому методу мы теперь тестик напишем?", "А вот если бы мы были настоящими программистами, мы бы наверно это протестировали?". Так вот, перво-наперво, стоит написать тесты!
